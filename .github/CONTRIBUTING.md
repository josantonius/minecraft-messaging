...
Start a [new discussion](https://github.com/josantonius/minecraft-messaging/discussions/new) and select the
...
- For a **Major Feature**,
first [open a new discussion](https://github.com/josantonius/minecraft-messaging/discussions/new) in the
...
[repository](https://github.com/josantonius/minecraft-messaging). Even better, you can
...
[new issue form](https://github.com/josantonius/minecraft-messaging/issues/new).
...
1. Search [GitHub](https://github.com/josantonius/minecraft-messaging/pulls) for an open or closed PR that
relates to your submission. You don't want to duplicate effort.

1. [Fork](https://github.com/josantonius/minecraft-messaging/fork) the repository to your own GitHub account.
...
1. In GitHub, send a [pull request](https://github.com/josantonius/minecraft-messaging/compare/main..)
to `minecraft-messaging:main`.
